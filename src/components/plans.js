...
<div className='rounded-full border w-[150px] h-[150px]'>
  ...
  src="https://img.freepik.com/free-photo/3d-illustration-darts-hitting-dartboard-target_107791-16385.jpg?size=626&ext=jpg&uid=R114683630&ga=GA1.2.134876288.1693412887&semt=ais" 
  alt="" />
</div>
<h1 data-aos="zoom-in" className='text-center italic border-b p-2 font-bold text-cyan-700 text-xl'>Goal Setting</h1>
<p className='text-center italic'>Have a goal towards fitness be it losing weight, toning, muscle growth or strength increase.</p>
</div>
<div className=' h-[320px] flex flex-col items-center p-2'>
{/**img div */}
<div className='rounded-full border w-[150px] h-[150px]'>
...
<p className='text-center italic'>Step out of that comfort zone and kill that procastination by having your first steps.</p>
</div>
<div className=' h-[320px] flex flex-col items-center p-2'>
{/**img div */}
<div className='rounded-full border w-[150px] h-[150px]'>
...
<p className='text-center italic'>Showing up everyday improves and adds on the later results, show up no matter what.</p>
</div>
<div className=' h-[320px] flex flex-col items-center p-2'>
{/**img div */}
<div className='rounded-full border w-[150px] h-[150px]'>
...
<p className='text-center italic'>We will be there when building, when in pain, when in gain & when celebrating the results.</p>
</div>
  </div>
</div>
      </div>
